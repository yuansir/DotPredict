    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <button 
          ...
          className="text-gray-300 hover:text-white transition-colors flex items-center space-x-1 px-3 py-1 rounded-md hover:bg-gray-700/50"
        >
          <span>{isRuleExpanded ? '收起规则' : '展开规则'}</span>
          {isRuleExpanded ? <FiChevronUp className="w-4 h-4" /> : <FiChevronDown className="w-4 h-4" />}
        </button>
      </div>
